		...
		<div class="wrapper  how-it-works_position">
			...
			<div class="how-it-works_steps-pos">
				<div class="steps">
					...
					<img class="steps__img-desktop" src="https://www.crossfood.od.ua/wp-content/themes/crossfood/src/img/dsg/steps.png" alt="Crossfood - как это работает">
					<img class="steps__img-mobile" src="https://www.crossfood.od.ua/wp-content/themes/crossfood/src/img/dsg/steps-mobile.png" alt="Crossfood - как это работает">
        ...
        <div class="desserts-drink-content">
            <div class="desserts-drinks__item desserts-drinks__desserts-block">
                ...
                <div class="desserts-drinks__item-media">
                    <img class="desserts-drinks__item-img" src="https://www.crossfood.od.ua/wp-content/themes/crossfood/src/img/dsg/backgrounds/dessets-home-bg.jpg" alt="Десерты Crossfood">
...
<!---->
<!--                <div class="desserts-drinks__item-media">-->
<!--                    <img class="desserts-drinks__item-img" src="https://www.crossfood.od.ua/wp-content/themes/crossfood/src/img/dsg/backgrounds/drinks-home-bg.jpg" alt="Напитки Crossfood">-->
<!---->
<!--                    <div class="desserts-drinks__btn-cont">-->
