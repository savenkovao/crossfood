      ...
      <div class="dd-block">
        <div class="main-carousel-cont">
          <div id="carousel" class="carousel slide" data-interval="false">
            ...
            <a href="#carousel" class="left carousel-control main-carousel__control dd__carousel-arrow"
               data-slide="prev">
            </a>
            <a href="#carousel" class="right carousel-control main-carousel__control dd__carousel-arrow"
               data-slide="next">
            </a>
          </div>
        </div>
