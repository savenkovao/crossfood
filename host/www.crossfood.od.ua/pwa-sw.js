const CACHE_VERSION = '1.7.1.1';

const BASE_CACHE_FILES = [
    'https://crossfood.od.ua/wp-content/uploads/2019/10/CF-logo-icon-2.png',
'https://crossfood.od.ua/wp-content/uploads/2019/10/CF-logo-icon-512.png',
...
const OFFLINE_PAGE = 'https://crossfood.od.ua';
const NOT_FOUND_PAGE = 'https://crossfood.od.ua';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://crossfood.od.ua/wp-admin/');
//    },
];
